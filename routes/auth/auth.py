...
class Auth:
    def __init__(self):
        ...
        self.router.add_api_route('/generate_otp', self.__generate_before_auth_otp, methods=['POST'])
        self.router.add_api_route('/signup', self.__signup, methods=['POST'])
        self.router.add_api_route('/generate_otp', self.__generate_after_auth_otp, methods=['PUT'])
